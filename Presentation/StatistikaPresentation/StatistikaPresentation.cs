...
namespace Presentation.StatistikaPresentation
{
    public class StatistikaPresentation
    {
        private readonly IDatotekaPrikaz _datotekaPrikaz;
        private readonly ITabelarniPrikaz _tabelarniPrikaz;

        public StatistikaPresentation(IDatotekaPrikaz datotekaPrikaz, ITabelarniPrikaz tabelarniPrikaz)
        {
